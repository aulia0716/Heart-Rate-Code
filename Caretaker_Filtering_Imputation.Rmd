...
The imputation code use the random number from normal distribution to fill out the gap. I use the function `rnorm` without using `set.seed` function. This means that every time we do the imputation for the same data set, the result will generate a different random number. 
