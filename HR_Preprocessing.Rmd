...
The file naming in this code still uses the Dropbox naming format. To apply this code to real participants, you should use the following naming convention format: O:\WorkLife-Data\biomonitors\holter_ecg\participantID\participantID_advhrv.txt. 
For example, to access participant 19003's data, use this address: O:\WorkLife-Data\biomonitors\holter_ecg\19003\19003_advhrv.txt. 
You should also have a full access to the O:\ drive to apply this code to the real dataset. 
...
All the filtering and imputation code in this file is commented out and presented only for for documentation purpose to provide information about the workflow to the user. The final version of the filtering and imputation can be accessed from the file Filtering_Imputation.rmd
